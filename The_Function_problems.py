...
def tuple_sum(A, B):
    ...
    [(3, 5), (4, 6), (9, 10)]
    '''
    return [(a[0]+b[0],a[1]+b[1]) for (a,b) in list(zip(A, B))]
...
comprehension_with_row = [j+row(p,15) for j in range(20)]

comprehension_without_row = [j+[p+i for i in range(15)] for j in range(20)]
